...
<body>
    ...
    <h1 class="titulo"> Opciones Usuario</h1>
                ...
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        ...
                        <div class="btnContainer">
                           <a href="Usuario?enviar=registerUsu"> <button class="">Ingresar</button></a>
                        </div>
            ...
            <div class="prendas">
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        <h2>Consultar</h2>
                        <div class="btnContainer">
                            <a href="Usuario?enviar=ConsultarUsu"> <button class="btnEliminar">Ingresar</button></a>
