...
<body>
    ...
    <h1 class="titulo"> Opcion De Materiales</h1>
                ...
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        ...
                        <div class="btnContainer">
                            <a href="MaterialesEmple?enviar=RegisterMateriales"> <button class="">Ingresar</button></a>
                        </div>
            ...
            <div class="prendas">
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        <h2>Consultar</h2>
                        <div class="btnContainer">
                            <a href="MaterialesEmple?enviar=ConsultarMateriales"> <button class="btnEliminar">Ingresar</button></a>
