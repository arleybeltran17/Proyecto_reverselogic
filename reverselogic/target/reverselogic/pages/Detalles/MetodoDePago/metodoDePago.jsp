                ...
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        ...
                        <div class="btnContainer">
                            <a href="MetodoDePago?enviar=registrarMetod"> <button class="">Ingresar</button></a>
                        </div>
            ...
            <div class="prendas">
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        <h2>Consultar</h2>
                        <div class="btnContainer">
                            <a href="MetodoDePago?enviar=ConsultarMetod"> <button class="btnEliminar">Ingresar</button></a>
