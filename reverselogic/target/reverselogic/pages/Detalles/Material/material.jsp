                ...
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        ...
                        <div class="btnContainer">
                            <a href="Material?enviar=registerMaterial"> <button class="">Ingresar</button></a>
                        </div>
            ...
            <div class="prendas">
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        <h2>Consultar</h2>
                        <div class="btnContainer">
                            <a href="Material?enviar=consultarMaterial"> <button class="btnEliminar">Ingresar</button></a>
