...
<body>
                ...
                <ul>
                    <li class="submenu">
                        ...
                        <ul>
                            ...
                            <li><a href="/Crud/reverselogic/reverselogic/src/main/webapp/index.jsp"><button>Menu</button> </a></li>
                            <li>
    ...
    <h1 class="titulo"> Opciones Devolucion</h1>
                ...
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        ...
                        <div class="btnContainer">
                           <a href="Devolucion?enviar=registerDevo"> <button class="">Ingresar</button></a>
                        </div>
            ...
            <div class="prendas">
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        <h2>Consultar</h2>
                        <div class="btnContainer">
                       <a href="Devolucion?enviar=consultarDevolucion"><button class="btnEliminar">Ingresar</button></a>
