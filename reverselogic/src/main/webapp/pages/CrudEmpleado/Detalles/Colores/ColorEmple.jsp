...
<body>
    ...
    <h1 class="titulo"> Opciones De Color</h1>
                ...
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        ...
                        <div class="btnContainer">
                            <a href="ColoresEmple?enviar=RegistrarColores"> <button class="">Ingresar</button></a>
                        </div>
            ...
            <div class="prendas">
                <div class="imgChaqueta">
                    ...
                    <div class="detalle">
                        <h2>Consultar</h2>
                        <div class="btnContainer">
                            <a href="ColoresEmple?enviar=ConsultarColores"> <button class="btnEliminar">Ingresar</button></a>
